# Tesla Powerwall 3 Home Assistant Integration

A Home Assistant integration that gathers basic Powerwall 3 information through local polling without having to bridge the Powerwall's own WiFi network.
